...
export default function CartHOC(props) {
    const theme = useTheme();
    return <Cart theme={theme} {...props} />;
}
                    ...
                    <Content style={{paddingRight: 10}}>
                        ...
                        <Grid style={{marginTop: 20, marginBottom: 10}}>
                            <Col style={{paddingLeft: 10,paddingRight: 5}}>
                                <Button onPress={() => this.checkout()} style={{backgroundColor: theme.colors.navbarBackgroundColor}} block iconLeft>
                                    <Icon name='ios-card' />
                                    <Text style={{color: '#fdfdfd'}}>Checkout</Text>
                                </Button>
                            </Col>
                            <Col style={{paddingLeft: 5, paddingRight: 10}}>
                                <Button onPress={() => this.removeAllPressed()} style={{borderWidth: 1, borderColor: theme.colors.navbarBackgroundColor}} block iconRight transparent>
                                    <Text style={{color: theme.colors.navbarBackgroundColor}}>Emtpy Cart</Text>
                                    <Icon style={{color: theme.colors.navbarBackgroundColor}} name='ios-trash-outline' />
                                </Button>
                            </Col>
                        </Grid>
                    </Content>
